  ...
  <div class="container">
    ...
    <el-dialog class="new-dic" title="新增数据字典" :visible.sync="dicVisible" width="30%">
      <el-form :model="dicData" label-width="100px">
        ...
        <el-form-item label="说明：">
          <el-input placeholder="请输入" maxlength="40" v-model="dicData.explain" type="textarea" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog class="new-dic" title="编辑数据字典" :visible.sync="editVisible" width="30%">
      <el-form :model="dicEdit" label-width="100px">
        ...
        <el-form-item label="说明：">
          <el-input placeholder="请输入" maxlength="40" v-model="dicEdit.explain" type="textarea" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    submitDic() {
      ...
      if (dicData.name.trim().length==0) {
        this.$message.error('请输入字典名！')
        return
      }
      if (dicData.value.trim().length==0) {
