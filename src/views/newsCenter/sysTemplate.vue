<template>
  <div class="container">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="模板类型">
            <el-select placeholder="请选择模板类型" v-model="query.modelType">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item label="模板标题">
            <el-input placeholder="请输入模板标题" v-model="query.modelTitle" class="input_style"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
    ...
    <el-table :data="tableData" style="width: 100%" class="comTable" empty-text="没有符合条件的消息模板">
      <el-table-column prop="modelName" label="模板名称"></el-table-column>
      <el-table-column prop="modelTypeVal" label="模板类型"></el-table-column>
      <el-table-column prop="modelTitle" label="模板标题"></el-table-column>
      <el-table-column prop="noticeData" label="模板内容">
