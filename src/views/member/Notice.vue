<template>
  <div class="container">
    ...
    <el-table :data="tableData" style="width: 100%;margin-top:20px" empty-text="没有符合条件的通知公告">
      <el-table-column prop="noticeTitle" label="通知公告"></el-table-column>
      <el-table-column prop="noticeData" label="公告内容" width="250px" class-name="cotent">
...
export default {
  ...
  methods: {
    ...
    showTable(param) {
      ...
      apiShow("member", "noticeTable", { ...param, ...query }).then(reslove => {
