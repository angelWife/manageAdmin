  ...
  <div class="container">
    ...
    <div class="formModal">
      ...
      <el-table :data="tableData" style="width: 100%">
        <el-table-column prop="busWater" label="业务流水"></el-table-column>
        ...
        <el-table-column prop="billState" label="发票寄送状态"></el-table-column>
...
export default {
  data() {
    return {
      leftMenu: [
        { name: "会员基本信息", active: false, id: "#basicInfo" },
        ...
        { name: "变更记录", active: false, id: "#changeNote" },
        { name: "缴费记录", active: true, id: "#payNote" }
      ],
      tableData: [
        {
          busWater: "JF0912019092603551",
          busName: "2019年会员年费",
          money: "50000.00",
